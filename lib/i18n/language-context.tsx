...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    "notifications.types.booking_paid": "Pagamento ricevuto",
    ...
    "profile_edit.avatar_change": "Cambia foto",
    "profile_edit.avatar_uploading": "Caricamento...",
    "profile_edit.avatar_upload_error": "Impossibile caricare la foto",
    "profile_edit.avatar_invalid_type": "Formato non supportato: usa JPG, PNG o WebP",
    "profile_edit.avatar_too_large": "L'immagine supera i 5MB",
    "profile_edit.display_name_label": "Nome visualizzato",
    "profile_edit.display_name_placeholder": "Es. Mario Rossi",
    "profile_edit.display_name_required": "Il nome visualizzato e obbligatorio",
    "profile_edit.bio_label": "Breve descrizione",
    "profile_edit.bio_placeholder": "Raccontaci qualcosa di te...",
    "profile_edit.phone_label": "Telefono",
    "profile_edit.phone_placeholder": "Es. +39 333 1234567",
    "profile_edit.phone_privacy_hint": "Il numero di telefono resta privato: non sarà visibile ad altri utenti.",
    ...
    "reviews.comment_placeholder": "Racconta com'è andata (facoltativo)",
    "reviews.tags_label": "Aggiungi un tag rapido (facoltativo)",
    "reviews.details_toggle_show": "Mostra dettagli",
    "reviews.details_toggle_hide": "Nascondi dettagli",
    "reviews.submit": "Invia recensione",
    "reviews.submitting": "Invio in corso...",
    "reviews.already_reviewed": "Hai già lasciato una recensione",
    "reviews.awaiting_counterpart":
      "Recensione inviata: sarà pubblicata quando anche la controparte avrà recensito, o comunque entro 14 giorni dalla chiusura del noleggio",
    "reviews.published": "Recensione pubblicata",
    "reviews.window_closed": "La finestra di 14 giorni per lasciare una recensione è scaduta",
    "reviews.not_yet_available": "Potrai lasciare una recensione a noleggio concluso",
    "reviews.error_generic": "Impossibile inviare la recensione",
    "reviews.rating_summary_title": "Valutazioni",
    "reviews.as_lender": "Come prestatore",
    "reviews.as_renter": "Come noleggiatore",
    "reviews.no_reviews_yet": "Nessuna recensione ancora",
    "reviews.load_more": "Carica altre",
    "reviews.sub_rating.item_match": "Corrispondenza con la descrizione",
    "reviews.sub_rating.item_condition": "Stato e manutenzione",
    "reviews.sub_rating.pickup_timeliness": "Puntualità al ritiro",
    "reviews.sub_rating.service": "Cortesia e assistenza",
    "reviews.sub_rating.delivery_timeliness": "Puntualità alla consegna",
    "reviews.sub_rating.communication": "Comunicazione",
    "reviews.sub_rating.trust_overall": "Fiducia complessiva",
    "reviews.sub_rating.item_care": "Cura dell'oggetto",
    "reviews.sub_rating.return_timeliness": "Puntualità alla riconsegna",
    "reviews.sub_rating.cleanliness": "Pulizia alla riconsegna",
  },
  en: {
    // Header
    "nav.home": "Home",
    ...
    "notifications.types.booking_paid": "Payment received",
    ...
    "profile_edit.avatar_change": "Change photo",
    "profile_edit.avatar_uploading": "Uploading...",
    "profile_edit.avatar_upload_error": "Could not upload the photo",
    "profile_edit.avatar_invalid_type": "Unsupported format: use JPG, PNG or WebP",
    "profile_edit.avatar_too_large": "The image is larger than 5MB",
    "profile_edit.display_name_label": "Display name",
    "profile_edit.display_name_placeholder": "E.g. John Doe",
    "profile_edit.display_name_required": "Display name is required",
    "profile_edit.bio_label": "Short bio",
    "profile_edit.bio_placeholder": "Tell us something about yourself...",
    "profile_edit.phone_label": "Phone",
    "profile_edit.phone_placeholder": "E.g. +1 555 1234567",
    "profile_edit.phone_privacy_hint": "Your phone number stays private: it won't be visible to other users.",
    ...
    "reviews.comment_placeholder": "Tell us how it went (optional)",
    "reviews.tags_label": "Add a quick tag (optional)",
    "reviews.details_toggle_show": "Show details",
    "reviews.details_toggle_hide": "Hide details",
    "reviews.submit": "Submit review",
    "reviews.submitting": "Submitting...",
    "reviews.already_reviewed": "You've already left a review",
    "reviews.awaiting_counterpart":
      "Review submitted: it will be published once the other party also reviews, or within 14 days of the rental ending",
    "reviews.published": "Review published",
    "reviews.window_closed": "The 14-day window to leave a review has expired",
    "reviews.not_yet_available": "You'll be able to leave a review once the rental is completed",
    "reviews.error_generic": "Couldn't submit the review",
    "reviews.rating_summary_title": "Ratings",
    "reviews.as_lender": "As lender",
    "reviews.as_renter": "As renter",
    "reviews.no_reviews_yet": "No reviews yet",
    "reviews.load_more": "Load more",
    "reviews.sub_rating.item_match": "Match with description",
    "reviews.sub_rating.item_condition": "Condition and maintenance",
    "reviews.sub_rating.pickup_timeliness": "Pickup timeliness",
    "reviews.sub_rating.service": "Courtesy and service",
    "reviews.sub_rating.delivery_timeliness": "Delivery timeliness",
    "reviews.sub_rating.communication": "Communication",
    "reviews.sub_rating.trust_overall": "Overall trust",
    "reviews.sub_rating.item_care": "Item care",
    "reviews.sub_rating.return_timeliness": "Return timeliness",
    "reviews.sub_rating.cleanliness": "Cleanliness on return",
  },
}
